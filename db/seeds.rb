...
user = User.find(1)
user.bills.create!(title:'Mom\'s birthday', description:'Dinner at Tung Lok and present', total_price: 320.70, since:'2016-12-12', picture: 'http://res.cloudinary.com/butteryhood/image/upload/v1479265360/defj8qgdnkiqpgug8myq.jpg')
user.bills.create!(title:'Beer night', description:'Drinks at Raffles Club', total_price: 220.00, since:'2016-12-12', picture: 'http://res.cloudinary.com/butteryhood/image/upload/v1479265552/ctsoviyblkihfehylazr.jpg')
user.bills.create!(title:'Mashmallow Challenge', description:'Team Building Event. To build tallest structure with only mashmallow and sticks', total_price: 50.00, since:'2016-12-12', picture: 'http://res.cloudinary.com/butteryhood/image/upload/v1479265668/ttkbgzriva8f4txmwxbm.jpg')
user.bills.create!(title:'Division Barbeque', description:'Quaterly Division Celebration', total_price: 426.10, since:'2016-12-12', picture:'http://res.cloudinary.com/butteryhood/image/upload/v1479265980/oakjjqfoihso3ekinvnn.jpg')
...
bill.items.create!(item_name:'Standard Mashmallows', item_price: 20.00)
bill.items.create!(item_name:'Skewer Sticks', item_price: 30.00)
